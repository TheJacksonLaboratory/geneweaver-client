...
class LegacyClientPaths(BaseModel):
    ...
    GET_GENESETS_BY_GENE_REF_ID: str = '/api/get/geneset/bygeneid/{apikey}/{gene_ref_id}/{gdb_name}/'
    GET_GENESETS_BY_GENE_REF_ID_HOMOLOGY: str = '/api/get/geneset/bygeneid/{apikey}/{gene_ref_id}/{gdb_name}/homology'
    GET_GENESET_BY_USER: str = '/api/get/geneset/byuser/{apikey}/'
    GET_ONTOLOGY_BY_GENESET_ID: str = '/api/get/ontologies/bygeneset/{apikey}/{geneset_id}/'
    ...
    GET_GENESET_BY_PROJECT_ID: str = '/api/get/geneset/byprojectid/{apikey}/{project_id}/'
    ...
    GET_GENE_DATABASE_BY_ID: str = '/api/get/genedatabase/byid/{apikey}/{gene_database_id}/'

    ADD_PROJECT_BY_USER: str = '/api/add/project/byuser/{apikey}/{project_name}/'
    ADD_GENESET_TO_PROJECT: str = '/api/add/geneset/toproject/{apikey}/{project_id}/{geneset_id}/'
    ADD_GENESET_BY_USER: str = "/api/add/geneset/byuser/{apikey}/"

    DELETE_GENESET_FROM_PROJECT: str = '/api/delete/geneset/fromproject/{apikey}/{project_id}/{geneset_id}/'
